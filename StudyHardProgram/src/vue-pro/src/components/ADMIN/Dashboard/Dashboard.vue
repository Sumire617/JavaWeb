	...
	<el-container class="interface-container">
		...
		<el-aside :width="isCollapse ? '64px' : '200px'" class="aside">
			...
			>
				...
				<el-menu-item index="/dashboard/userManage">
					<el-icon><Avatar /></el-icon>
					<template #title>用户管理</template>
				</el-menu-item>

				<el-sub-menu index="/dashboard/job">
					<template #title>
						<el-icon><Briefcase /></el-icon>
						<span>岗位管理</span>
					</template>
					<el-menu-item index="/dashboard/job/jobList">岗位列表</el-menu-item>
					<el-menu-item index="/dashboard/job/jobAudit">岗位审核</el-menu-item>
				</el-sub-menu>

				<el-menu-item index="/dashboard/dataAnalysis">
